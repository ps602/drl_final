...
from small_grid.data.build_file_new import gen_rou_file

sns.set_color_codes()

SMALL_GRID_NEIGHBOR_MAP = {'nt1': ['nt2', 'nt4'],
                           'nt2': ['nt1', 'nt3'],
                           'nt3':  ['nt2', 'nt4'],
                           'nt4': ['nt3', 'nt1']}

STATE_NAMES = ['wave', 'wait']
# map from ild order (alphabet) to signal order (clockwise from north)
...
if __name__ == '__main__':
    ...
    config.read('./config/config_maddpg_large.ini')

...
# changing phases according to already existing phases
    ...
    def _get_state(self):
        ...
        for node_name in self.node_names:
            ...
            if self.agent == 'greedy':  # checking if agent mentions greedy
            ...
            elif self.agent == 'ddpg':  # checking if the agent is a2c
                ...
                for nnode_name in node.neighbor:  # iterating through the neighbor
                    if self.agent != 'maddpg':  # for agent where its not ma2c
                ...
                if self.agent == 'maddpg':  # checking agent to be ma2c
                ...
                #print('++++++++++++++++++++++cur_state_statefn')
                #print(cur_state)# state appended with cur_state
    ...
    def _init_policy(self):
        ...
        for node_name in self.node_names:  # iterating thru node_names
            ...
            # taking phase_num as n_a found by np.prod(self.n_a_ls)
            p = 1. / phase_num
            # making p array equal to element wise 1/
            policy.append(np.array([p] * phase_num))
            #print('+++++++++++++++++++++++++++++++')
            #print(policy)# appending to polciy array (p * phase num) but why??
        return policy
    ...
    def _init_state_space(self):
        ...
        for node_name in self.node_names:  # iterating thru all the node_names
            ...
            for nnode_name in node.neighbor:  # iterating thru neighbor nodes
                ...
                if self.agent == 'maddpg':  # checking for ma2c
        ...
        for node_name in self.node_names:
            ...
            for state_name in self.state_names:  # iterating over state_names
                if state_name == 'wave':  #checking if state_name is wave
                    ...
                    #print('++++++++++++++++++++++++++++++++++cur_state')
                    #print(cur_state)# making it a numpy array
...
# function to get state variable values from sumo environment and normalise them
    ...
    def _reset_state(self):
        for node_name in self.node_names:  # iterating thru node_names
            ...
            #print('+++++++++++++++++++++++++++++++')
            #print(node.num_state)# making fingerprint as node.n_a-1 ??
    ...
    def step(self, action):
        ...
        if self.agent in ['ddpg' 'greedy']:
            reward = global_reward
        elif self.agent != 'maddpg':

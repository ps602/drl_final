...
# FLOW_MULTIPLIER = 0.8
FLOW_MULTIPLIER = 1.0  # declaring flow_multiplier as 1
SPEED_LIMIT = 20  # declaring speed_limit as 20
L0, L1 = 200, 400  # declaring L0,L1 = 200 and 400
L0_end = 75  # declaring L0_end as 75

def write_file(path, content):
    with open(path, 'w') as f:
        f.write(content)  # function to write into file
...
def output_flows(flow, num_car_hourly):
    ...
    flow1 = '  <flow id="mf_%s" departPos="random_free" begin="%d" end="%d" probability="' + \
            prob + '" type="type1">\n' + \
            '    <route edges="%s"/>\n  </flow>\n'
    routes = ['nt1_npc npc_nt5 nt5_np11',  # 0
              'nt1_npc npc_nt5 nt5_nt6 nt6_np12',  # 1
              'nt4_nt5 nt5_np11',  # 2
              'nt4_nt5 nt5_nt6 nt6_np12',  # 3
              'nt1_nt2 nt2_np4',  # 4
              'nt1_nt6 nt6_np13',  # 5
              'nt1_npc npc_nt3 nt3_np6',  # 6
              'nt1_npc npc_nt3 nt3_nt2 nt2_np5',  # 7
              'nt4_nt3 nt3_np6',  # 8
              'nt4_nt3 nt3_nt2 nt2_np5']  # 9
    ...
    flows = [[500, 100, 700, 800, 550, 550, 100, 200, 250, 250, 400, 800],
             ...
             [100, 400, 4200, 200, 600, 550, 100, 500, 500, 800, 400, 200],
